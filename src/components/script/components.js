                    ...
                    <div id="notice-body">
                        ...
                        <div class="lang-content bn">
                            ...
                            <ul>
                                ...
                                <p>&nbsp;</p> <
a href = "./publications.html?scroll=main- content&openFirst=true" > প্রশ্ন বিচিত্রা কিনুন < / a>
                                <p>&nbsp;</p>
    ...
    getSchoolList: function () {
        return `
            ...
            <hr>
            <option value="AL AMEEN MISSION HASNECHAN">AL AMEEN MISSION HASNECHAN</option>
            <hr>
            ...
            <hr>
            <option value="ATABAR MEMORIAL K. G. SCHOOL">ATABAR MEMORIAL K. G. SCHOOL</option>
            <hr>
            ...
            <hr>
            <option value="GOURIPUR SRI SRI RAMKRISHNA VIDYAPITH (H.S.)">GOURIPUR SRI SRI RAMKRISHNA VIDYAPITH (H.S.)
            </option>
            <hr>
            ...
            <hr>
            <option value="KHALISANI JATIYA VIDYAPITH HIGH SCHOOL (H.S.)">KHALISANI JATIYA VIDYAPITH HIGH SCHOOL (H.S.)
            </option>
            <hr>
            ...
            <hr>
            <option value="P.M. SHRI KENDRIYA VIDYALAYA SANTRAGACHI (CBSE)">P.M. SHRI KENDRIYA VIDYALAYA SANTRAGACHI
            </option>
            <hr>
            ...
            <hr>
            <option value="S.T. AUGUSTIN'S DAY SCHOOL (ULUBERIA)">S.T. AUGUSTIN'S DAY SCHOOL (ULUBERIA)</option>
            <hr>
            ...
            <hr>
            <option value="ULUBERIA BINAPANI GIRLS' HIGH SCHOOL (H.S.)">ULUBERIA BINAPANI GIRLS' HIGH SCHOOL (H.S.)
            </option>
            <hr>
