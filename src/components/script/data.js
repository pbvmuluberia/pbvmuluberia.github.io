...
const translations = {
    'en': {
        ...
        'correct': 'Correct',
        'update_student_data': 'Corrected Data',
        'grade': 'Grade:',
        ...
        'enter_valid_name': 'Please enter atleast first 7 letter of your name',
        'enter_valid_school': 'Please select your school',
        ...
        'submit_success': 'Data submitted successfully! Please check after 24 Hours.',
        'submit_error': 'This Mobile number is not submitted with the Form.',
        ...
        'enter_valid_mobno': 'Enter Valid Mobile No',
    ...
    'bn': {
        ...
        'submit_correction': 'সংশোধিত তথ্য জমা দিন',
        'correct': 'সংশোধন করুন',
        'update_student_data': 'সঠিক তথ্য লিখুন',
        ...
        'Submitting_data': 'তথ্য পাঠানো হচ্ছে ...',
        'submit_success': 'আমরা সংশোধনের আবেদন পেয়েছি। ২৪ ঘন্টা পরে পুনরায় মিলিয়ে দেখুন',
        'submit_error': 'এই মোবাইল নম্বরটি আপনি ফর্মে লেখেন নি।',
